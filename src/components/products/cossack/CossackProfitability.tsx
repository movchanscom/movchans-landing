...
const CossackProfitability = () => {
  const t = useScopedI18n('products.cossack.areaGraph');
  ...
  const translatedData = COSSACK_AREAS_DATA.map((item) => ({
    ...item,
  ...
  return (
    <HistoricalProfitability product='cossack'>
...
export default CossackProfitability;
