...
import { LanguagesType } from '@/types/constants.type';
...
const ArgoProfitability = () => {
  const t = useScopedI18n('products.argo.areaGraph');
  ...
  const translatedData = ARGO_AREAS_DATA.map((item) => ({
    ...item,
  ...
  return (
    <HistoricalProfitability product='argo'>
...
export default ArgoProfitability;
