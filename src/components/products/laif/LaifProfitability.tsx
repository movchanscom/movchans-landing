...
const LaifProfitability = () => {
  const t = useScopedI18n('products.laif.areaGraph');
  ...
  const translatedData = LAIF_AREAS_DATA.map((item) => ({
    ...item,
  ...
  return (
    <HistoricalProfitability product='laif'>
...
export default LaifProfitability;
