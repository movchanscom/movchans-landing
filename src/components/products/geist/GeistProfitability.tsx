...
const GeistProfitability = () => {
  const t = useScopedI18n('products.geist.areaGraph');
  ...
  const translatedData = GEIST_AREAS_DATA.map((item) => ({
    ...item,
  ...
  return (
    <HistoricalProfitability product='geist'>
...
export default GeistProfitability;
